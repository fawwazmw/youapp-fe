...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginFormValues) => {
    try {
      ...
      const payload = isEmail 
        ...
        : { email: data.email, password: data.password, username: data.email };
  ...
  return (
    <main className="min-h-screen flex flex-col p-4 sm:p-8 text-white relative">
      ...
      <div className="flex-grow flex flex-col justify-center w-full max-w-md mx-auto pt-16">
        <h1 className="text-2xl font-bold mb-8 pl-2">Login</h1>
